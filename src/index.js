...
const TEST_EQUIPMENT_INPUT = Object.freeze({
  ...
  async startSession(purpose, options = {}) {
    ...
    return this.enqueueLifecycleIntent(`session-${action}`, async (owner) => {
      ...
      try {
        ...
        if (action === "test") this.testEquipmentVisible = false;
