...
export class AeroGame extends HTMLElement {
  ...
  computeFlowZoneDirections(graph) {
    ...
    const config = validateEquipmentConfig(equipmentConfigDefaults).flow.saber;
  ...
  syncDebugCameraPresentation() {
    ...
    this.renderEnvironmentControls(); const bounceEnabled=this.testPresentationAuthoringSnapshot().enabled;if(this.testPresentationAuthoringEnabled&&!bounceEnabled)this.invalidateTestPresentationPicker();this.testPresentationAuthoringEnabled=bounceEnabled;this.renderTestPresentationControls();this.syncDebugCameraControlState(snapshot);
  }
