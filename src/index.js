...
.debug-controls-collapse{min-inline-size:44px;min-block-size:44px;justify-self:start;font-size:24px}.visual-test-authoring-body{display:grid;gap:8px;max-block-size:min(58vh,620px);overflow:auto;overscroll-behavior:contain;padding-inline-end:2px}.environment-authoring,.environment-fields{display:grid;gap:6px}.environment-authoring{border-block-start:1px solid rgba(255,255,255,.25);padding-block-start:8px}.environment-authoring select,.environment-authoring button,.environment-authoring input[type=number]{min-block-size:44px;touch-action:manipulation}.environment-authoring select,.environment-authoring input[type=number]{inline-size:100%;font:inherit}.environment-fields{grid-template-columns:minmax(62px,1fr) minmax(64px,1fr) minmax(0,auto);align-items:center}.environment-fields label{font:700 12px system-ui;min-inline-size:0}.environment-fields input{min-inline-size:0}.environment-fields input[type=range]{min-block-size:44px;touch-action:manipulation}.environment-value{align-items:center;display:inline-flex;justify-self:end;max-inline-size:100%;min-inline-size:0;white-space:nowrap}.environment-value output{overflow-wrap:normal}.environment-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px}.environment-authoring output{font:700 11px system-ui;overflow-wrap:anywhere}.environment-authoring [data-error=true]{color:#ffb4b4}.debug-camera-controls :focus-visible{outline:3px solid var(--aero-color-focus,#72dcff);outline-offset:2px}
