...
| `@aerobeat/web-renderer` | `4153e963ce840b50b8f95e2be0679ed88ab8dded` | `e77db3502dcfc39e7bd146df149dbab090b5178b` |
...
Raw `0.0.36` remains immutable failed physical evidence. Raw `0.0.37` is its append-only automated successor; it has not been served, independently reproduced/served-byte audited, or physically approved.
