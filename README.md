...
Raw `0.0.36` remains immutable failed physical evidence, and raw `0.0.37` and `0.0.38` remain immutable rejected physical evidence. Raw `0.0.39` is the append-only automated successor; it has not been independently release-QA audited, served, or physically approved.
