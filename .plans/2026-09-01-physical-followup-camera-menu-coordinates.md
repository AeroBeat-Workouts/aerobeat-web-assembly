...
**Status:** PACK-POLICY P0 `aerobeat-web-assembly-qmc` CODER PASS / INDEPENDENT QA IN PROGRESS — subagent `8c9c0c07-61e9-4796-a956-8864e4349ad6`; complete trusted npm metadata + canonical gzip/USTAR byte grammar implemented; authoritative normalized identity unchanged; `qmc`, `cf1`, `1wu`, and `nme` remain open; audit/server blocked
