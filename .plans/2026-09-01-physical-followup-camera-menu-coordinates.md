...
**Status:** PACK-POLICY QA FAIL / P0 `aerobeat-web-assembly-nji` DIAGNOSED — caller-authored metadata is a circular inventory/hash authority; internal pinned npm derivation repair pending; `nji`, `qmc`, `cf1`, `1wu`, and `nme` remain open; audit/server blocked
