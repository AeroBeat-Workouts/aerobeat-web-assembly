...
**Status:** PACK-POLICY P0 `aerobeat-web-assembly-nji` CODER PASS / INDEPENDENT QA-AUDIT PENDING — caller metadata removed as authority; verifier internally derives pinned npm truth in an isolated sanitized runtime; normalized identity unchanged; `nji`, `qmc`, `cf1`, `1wu`, and `nme` remain open; audit/server blocked
