...
**Status:** PACK-POLICY P0 `aerobeat-web-assembly-qmc` CODER PASS / INDEPENDENT QA-AUDIT PENDING — complete trusted npm metadata + canonical gzip/USTAR byte grammar implemented; authoritative normalized identity unchanged; `qmc`, `cf1`, `1wu`, and `nme` remain open; audit/server blocked
