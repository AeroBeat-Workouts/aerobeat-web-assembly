(function() {
	...
	*/
	...
	function convertFlowChart(summary, difficulty, songToken) {
		...
		return {
			chart: {
				schemaId: "aerobeat.chart.flow.v3",
				schemaVersion: 3,
				recordVersion: 2,
	...
	*/
	async function validateAuthoredPackage(packageValue) {
		...
		if (packageValue.schemaId !== "aerobeat.song-package.v3" || packageValue.schemaVersion !== 3 || packageValue.packageVersion !== "3.0.0") issue("package_schema_invalid", "schemaId", "Package schema must be aerobeat.song-package.v3 version 3 / package 3.0.0");
		...
		for (let index = 0; index < charts.length; index += 1) {
			...
			if (chart.mode === "flow") {
				flowCount += 1;
				if (chart.schemaId !== "aerobeat.chart.flow.v3" || chart.schemaVersion !== 3 || chart.rulesetId !== "flow_grid_v2") issue("flow_chart_schema_invalid", path, "Flow chart must use normalized obstacle schema/ruleset v3");
...
//# sourceMappingURL=conversion-worker-Go6s489B.js.map