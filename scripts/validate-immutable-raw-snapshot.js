...
for (const baseline of [BASELINE, SUCCESSOR_BASELINE, DB7_SUCCESSOR_BASELINE, RELEASE_043_BASELINE]) {
...
for (const line of releases) {
  ...
  const referenceCommit = version === "0.0.43" ? RELEASE_043_BASELINE : version === "0.0.41" ? DB7_SUCCESSOR_BASELINE : version === "0.0.40" ? SUCCESSOR_BASELINE : BASELINE;
...
assert.equal(snapshots.at(-1)?.version, "0.0.43");
assert.deepEqual(snapshots.slice(-8).map(({ version, tree, files, bytes, proofSha256 }) => ({ version, tree, files, bytes, proofSha256 })), [
...
assert.deepEqual(snapshots.at(-1), {
  ...
  bytes: 28199850,
  modes: ["100644"],
  proofSha256: "cb362e103db705ab0c3b7e9fc6666cafe8255a2d093acfd7a9a2dd5bc9b5f1c0",
  sourceFingerprint: "152671d9af8a564e4f79666f2214913b45f25f9a52a9e455f9aae11dcb4a92f8",
  aggregate: "8fbacabca35041000ec2bbd8b14fb3acc2c38731469d8cdc91575df5980ec90d",
  completeManifestAggregate: "bbbbb7a3e631bde42fba21b01fd1ba045bbdabf88d468c3c37a74e6fd111431b"
});
