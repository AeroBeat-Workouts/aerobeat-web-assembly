...
const RELEASE_047_TREE = "34ca887c5d51ae57e2257600a055d5625916d1a5";
const RELEASE_048_TREE = "cce1523b5e7ce5584aab4330d9d931daea5e6ffa";
...
const releases = [
  ...
  `040000 tree ${RELEASE_047_TREE}\t0.0.47`,
  `040000 tree ${RELEASE_048_TREE}\t0.0.48`
];
const snapshots = [];
for (const line of releases) {
  ...
  const referenceCommit = version === "0.0.48" || version === "0.0.47" || version === "0.0.46" ? "HEAD" : version === "0.0.45" ? RELEASE_045_BASELINE : version === "0.0.44" ? RELEASE_044_BASELINE : version === "0.0.43" ? RELEASE_043_BASELINE : version === "0.0.41" ? DB7_SUCCESSOR_BASELINE : version === "0.0.40" ? SUCCESSOR_BASELINE : BASELINE;
...
assert.equal(snapshots.at(-1)?.version, "0.0.48");
assert.deepEqual(snapshots.slice(-10).map(({ version, tree, files, bytes, proofSha256 }) => ({ version, tree, files, bytes, proofSha256 })), [
  ...
  { version: "0.0.47", tree: "34ca887c5d51ae57e2257600a055d5625916d1a5", files: 39, bytes: 28426893, proofSha256: "b37e6f36e81a4d6e97708d4f9c1c7b2d6d7b088756bfbd0715c3244a48282ea4" },
  { version: "0.0.48", tree: "cce1523b5e7ce5584aab4330d9d931daea5e6ffa", files: 39, bytes: 28437675, proofSha256: "79ffc77ed0f1ae4cb4428cbb8cab297abe3aab89de16fd9a46e4d07f5076db6e" }
]);
assert.deepEqual(snapshots.at(-1), {
  version: "0.0.48",
  tree: "cce1523b5e7ce5584aab4330d9d931daea5e6ffa",
  files: 39,
  bytes: 28437675,
  modes: ["100644"],
  proofSha256: "79ffc77ed0f1ae4cb4428cbb8cab297abe3aab89de16fd9a46e4d07f5076db6e",
  sourceFingerprint: "7cfbf9ccb7da96016fc6cda1a3de736ba2167ef152bf41807902bc27c6511101",
  aggregate: "0ff7e3d4d33896b1bb7b941e6a15f0fba735202c767d4c7d54b49e8f496b5e41",
  completeManifestAggregate: "fe3a8b1315e9001d381c06a4129262a770682b2e3e69d334286af92b42614184"
});
