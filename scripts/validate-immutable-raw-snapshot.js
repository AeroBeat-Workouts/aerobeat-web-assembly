...
for (const line of releases) {
  ...
  const referenceCommit = version === "0.0.47" || version === "0.0.46" ? "HEAD" : version === "0.0.45" ? RELEASE_045_BASELINE : version === "0.0.44" ? RELEASE_044_BASELINE : version === "0.0.43" ? RELEASE_043_BASELINE : version === "0.0.41" ? DB7_SUCCESSOR_BASELINE : version === "0.0.40" ? SUCCESSOR_BASELINE : BASELINE;
...
assert.equal(snapshots.at(-1)?.version, "0.0.47");
...
assert.deepEqual(snapshots.at(-1), {
  version: "0.0.47",
  tree: "34ca887c5d51ae57e2257600a055d5625916d1a5",
  files: 39,
  bytes: 28426893,
  modes: ["100644"],
  proofSha256: "b37e6f36e81a4d6e97708d4f9c1c7b2d6d7b088756bfbd0715c3244a48282ea4",
  sourceFingerprint: "3819c4d60100e625e8c62cd5458203810455b562290c958d6621d1cc93e668c3",
  aggregate: "337ff065ccd1c5f810cd20bca7beeb68d42e839986b70abdeced49cd644252a1",
  completeManifestAggregate: "bb4f45ee29b398344369eb8e9839150dd4accdd34527b908617f927681ccfded"
});
