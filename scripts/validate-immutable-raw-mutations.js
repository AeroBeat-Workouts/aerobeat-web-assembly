...
try {
  ...
  for (const version of ["0.0.37", "0.0.38", "0.0.39", "0.0.40", "0.0.41", "0.0.43", "0.0.44", "0.0.45", "0.0.46", "0.0.47", "0.0.48"]) {
...
console.log("Immutable raw mutation rejection passed for 0.0.37, 0.0.38, 0.0.39, 0.0.40, 0.0.41, 0.0.43, 0.0.44, 0.0.45, 0.0.46, 0.0.47, and 0.0.48 in a disposable worktree");
