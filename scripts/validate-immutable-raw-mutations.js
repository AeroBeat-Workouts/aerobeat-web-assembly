...
try {
  ...
  for (const version of ["0.0.37", "0.0.38", "0.0.39", "0.0.40", "0.0.41", "0.0.43"]) {
...
console.log("Immutable raw mutation rejection passed for 0.0.37, 0.0.38, 0.0.39, 0.0.40, 0.0.41, and 0.0.43 in a disposable worktree");
