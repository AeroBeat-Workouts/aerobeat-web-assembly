...
try {
  ...
  for (const version of ["0.0.37", "0.0.38", "0.0.39", "0.0.40"]) {
...
console.log("Immutable raw mutation rejection passed for 0.0.37, 0.0.38, 0.0.39, and 0.0.40 in a disposable worktree");
