...
async function runRow(browserInstance, row, origin) {
  ...
  if (row.importKind === "remote") {
    ...
    assert.deepEqual({ accepted: localResult.accepted, code: localResult.code }, { accepted: false, code: "event_interval_invalid" });
  }
