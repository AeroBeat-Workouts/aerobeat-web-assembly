...
for (const root of ["src", "test", "demo"]) {
  ...
  for (const file of collectFiles(root)) {
    ...
    const withoutAssemblyShellButtons = source.replace(/<button\b(?=[^>]*\bdata-action="(?:menu-toggle|menu-close|menu-backdrop|debug-camera-move|debug-camera-speed|debug-camera-reset|debug-camera-load|debug-camera-export|debug-controls-collapse|environment-config-load|environment-config-save|environment-asset-retry|test-presentation-reset|test-presentation-load|test-presentation-save|equipment-config-reset|equipment-config-export)")[^>]*>/gu, "").replace(/<input\b(?=[^>]*(?:\bdata-action="environment-select"|\bdata-environment-field=|\bdata-test-presentation-field=|\bdata-equipment-config-field=|\bdata-equipment-preview-toggle=|\bdata-test-automatic-feedback-toggle=|\bdata-equipment-mouse-hand=))[^>]*>/gu, "").replace(/<select\b(?=[^>]*(?:\bdata-action="environment-asset-select"|\bdata-test-presentation-field=|\bdata-equipment-config-field=))[^>]*>/gu, "");
