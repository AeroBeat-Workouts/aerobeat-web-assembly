...
try {
  ...
  const allowedDrawerText = new Set(["Calibrate / Start", "Gameplay", "Flow", "Semantic Row", "Spatial Row", "Semantic Cut", "Spatial Cut", "Visuals", "Default", "Compact", "Environment", "Aero", "Camera", "Music", "Search", "Latest", "Choose local ZIP", "First result", "Second result", "Preview", "Version", "1", "2", "Difficulty", "Expert", "Download", "Idle · 0%", "First library song", "Current library song", "Export", "Delete", "Cancel import", "Info", "Enter fullscreen", "Exit fullscreen"]);
