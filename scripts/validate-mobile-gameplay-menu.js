...
try {
  ...
  const allowedDrawerText = new Set(["Calibrate / Start", "Gameplay", "Flow", "Semantic Row", "Spatial Row", "Semantic Cut", "Spatial Cut", "Visuals", "Default", "Compact", "Environment", "Aero", "Camera", "Music", "Search", "Latest", "Choose local ZIP", "First result", "Second result", "Version", "Difficulty", "Expert", "Import selected map", "Idle · 0%", "First library song · Expert", "Current library song · Expert", "Export", "Delete", "Cancel import", "Info", "Enter fullscreen", "Exit fullscreen"]);
